...
module.exports = exports = function (sequelize, DataTypes) {
    const Fundraising = sequelize.define("Fundraising", {
        ...
        project_val: {type: DataTypes.BIGINT(11),"comment": "项目估值（货币单位：分）"},
        ...
        project_scale: {type: DataTypes.BIGINT(11),"comment": "筹集规模（货币单位：分）"},
        project_mode: {type: DataTypes.STRING(20),"comment": "筹集规模式:项目收益权、项目收益权"},
        minimum_subscription: {type: DataTypes.INTEGER,"comment": "最低认购数量"},
        ...
        subscribed_quantity: {type: DataTypes.INTEGER,"comment": "已认购数量"},
