...
module.exports = exports = function (sequelize, DataTypes) {
    const Invest = sequelize.define("Invest", {
        ...
        subscription_quantity: {type: DataTypes.FLOAT(12, 4),"comment": "认购数量"},
        project_status: {type: DataTypes.STRING(22),"comment": "项目状态"},
        buying_times: {type: DataTypes.BIGINT(20),"comment": "买入次数"},
        contract_address: {type: DataTypes.STRING(128),"comment": "合约地址"},
